...
/***********************************************************************************************
 * example: onclick="cart.addToCart(this, '7', 'Name of comic 7', '7')						
 **********************************************************************************************/
	...
	this.reCalc = function()
		...
		// *** //		 		
		this.widjetObj.html(local.goods + " " + num + " " + local.amount + " " + sum + " euro.");
		localStorage.setItem(this.cardID, JSON.stringify(this.DATA));
		}
	...
	this.renderBasketTable = function()
		...
		for(var idkey in this.DATA) 
			...
			with (this.DATA[idkey])
				...
				var productLine = '<tr class="bitem" id="wigoodline-' + id + '"> \
													...
													<td id="lineprice_' + id + '"class="wigoodprice">' + price + ' euro.</td> \
													<td> \
													...
													<td id="linesum_' + id + '">'+ parseFloat(price * num) +' euro.</td> \
		...
		for(var ids in this.IDS)
			...
			$("#linesum_" + cartItemID).html( parseFloat(price * cartNum) + ' euro.' );
